...
set :repository,  "git@github.com:asonas/#{application}.git"
set :scm, :git
set :branch, "master"
set :deploy_via, :remote_cache
set :deploy_to, "/home/asonas/#{application}"
...
namespace :deploy do
  ...
  task :restart, :roles => :app do
    if File.exist? "/home/asonas/#{application}/tmp/pids/unicorn.pid"
      run "kill -s USR2 `cat /home/asonas/#{application}/tmp/pids/unicorn.pid`"
    end
  end
  task :stop, :roles => :app do
    run "kill -s QUIT `cat /home/asonas/#{application}/tmp/pids/unicorn.pid`"
  end
end
